...
var PlayerControllerStates map[engine.State]bool = map[engine.State]bool{INGAME: true}

func (pc *PlayerController) States() map[engine.State]bool {
	return PlayerControllerStates
}
